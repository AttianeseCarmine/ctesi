...
python train_stage3.py --config configs/config_sha.yaml --ckpt_stage1 checkpoints/sha/stage1/best_model.pth --ckpt_stage2 checkpoints/sha/stage2/best_model.pth