...
#SBATCH --job-name=s3vitnwpu_train
...
#SBATCH -o logs/s3_nwpu_vit_%j.out
#SBATCH -e logs/s3_nwpu_vit_%j.err
...
#srun python train_stage1.py --config configs/config_vit_qnrf.yaml --data_dir data --batch_size 16 --input_size 384 --reduction 8  --dataset nwpu --batch_size 16 --amp --num_crops 2 --sliding_window --window_size 384 --stride 384  --out  checkpoints/nwpu/vit_b_16/stage1 
...
#VIT_B_16
#srun python train_stage1.py --config configs/config_vit_nwpu.yaml --dataset nwpu --data_dir data --batch_size 16 --out checkpoints/nwpu/vit_b_16/stage1

#srun python trainer.py  --dataset nwpu  --model clip_vit_b_16  --input_size 384  --reduction 8  --truncation 4  --anchor_points average  --prompt_type word  --batch_size 16  --num_crops 2  --amp  --sliding_window  --window_size 384  --stride 384  --count_loss dmcount  --weight_count_loss 1.0  --out checkpoints/nwpu/vit_b_16/stage2
