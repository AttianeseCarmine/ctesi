...
#SBATCH --job-name=s1vitnwpu_train
...
#SBATCH -o logs/s1_nwpu_vit_%j.out
#SBATCH -e logs/s1_nwpu_vit_%j.err
...
srun python train_stage1.py --config configs/config_vit_nwpu.yaml --data_dir data --batch_size 16 --input_size 448 --reduction 8  --dataset nwpu --batch_size 16 --amp --num_crops 2 --sliding_window --window_size 448 --stride 448  --out  checkpoints/nwpu/vit_b_16/stage1 
