...
#SBATCH --job-name=sha_vgg_STAGE23
...
#SBATCH -o logs/sha_vgg_STAGE23%j.out
#SBATCH -e logs/sha_vgg_STAGE23%j.err
...
srun python train_stage3_v3.py --config configs/config_sha.yaml --s1 checkpoints/sha/stage1/best_model.pth --s2 checkpoints/sha/stage2/best_model.pth --out checkpoints/sha/stage3