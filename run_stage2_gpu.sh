...
#SBATCH --job-name=stage2_sha_train
...
#SBATCH -o logs/stage2_%j_sha.out
#SBATCH -e logs/stage2_%j_sha.err
...
nvidia-smi
srun python train_stage2.py --config configs/config_sha.yaml