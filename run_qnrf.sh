...
#SBATCH --job-name=s1qnrfres_train
...
#SBATCH -o logs/s1_qnrf_res_%j.out
#SBATCH -e logs/s1_qnrf_res_%j.err
...
srun python train_stage1.py --config configs/config_vit_qnrf.yaml --data_dir data --batch_size 16 --input_size 224 --reduction 8  --dataset nwpu --batch_size 16 --amp --num_crops 1 --sliding_window --window_size 224 --stride 224  --out  checkpoints/qnrf/vit_b_16/stage1_v2
